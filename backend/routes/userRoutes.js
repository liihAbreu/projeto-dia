...
//Controllers
const {register, login, getCurrentUser, update, getUserById, getAllUsers, searchEmployee, updateEmployee, deleteUser, registerAuth, loginOAuth, registerEmployee, getAllUsersById, } = require("../controllers/userController.js")

//Middlewares
const validate = require("../middlewares/hendleValidation.js")
const {useCreateValidation, loginValidation, userUpdateValidation, useCreateValidationOAuth, loginValidationOAuth} = require('../middlewares/useValidation.js')

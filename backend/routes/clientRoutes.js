...
//Controllers
const { insertClient, getAllClients, getClientById, updateClient, deleteClient, updateServiceClient, updateFinishService, searchClient, getAllClientsById } = require("../controllers/clientController");
